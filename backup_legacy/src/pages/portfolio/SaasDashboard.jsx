      ...
      <div className="bg-glass-gradient border border-white/5 rounded-xl p-8 mb-8">
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
               ...
               <input type="email" defaultValue="admin@kreatospace.com" className="w-full bg-[#07111B] border border-white/10 rounded-lg px-4 py-3 text-white focus:border-brand-secondary outline-none" />
            </div>
