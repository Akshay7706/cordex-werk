        ...
        >
          ...
          <div className="relative z-10 w-full max-w-xs px-6">
            ...
            >
              ...
              <div className="flex justify-between mt-4 font-heading">
                <span className="text-[12px] text-brand-accent uppercase tracking-[0.5em] font-black italic">KREATO SPACE</span>
                <span className="text-[8px] text-gray-600 uppercase tracking-widest animate-pulse font-mono">System Integrity Verified</span>
              </div>
            </motion.div>
          </div>
        </motion.div>
