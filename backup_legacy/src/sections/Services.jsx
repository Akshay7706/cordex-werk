...
const services = [
  {
    title: 'LANDING PAGES',
    description: 'High-conversion landing pages engineered for startups. We focus on speed, clarity, and turning traffic into customers.',
    tag: '01',
    details: {
      technologies: ['React', 'Framer Motion', 'Tailwind CSS', 'Vite'],
      process: ['User Flow Mapping', 'Performance Tuning', 'A/B Test Ready', 'Mobile Optimization'],
      deliverables: ['Custom Landing Page', 'Lead Capture System', 'Technical SEO Setup'],
      image: 'https://images.unsplash.com/photo-1547658719-da2b51169166?auto=format&fit=crop&q=80&w=800'
    }
  },
  {
    title: 'STARTUP ECOSYSTEMS',
    description: 'Complete multi-page websites and brand foundations for growing startups. Scalable architecture that evolves with you.',
    tag: '02',
    details: {
      technologies: ['Next.js', 'Sanity CMS', 'PostgreSQL', 'Auth Systems'],
      process: ['Brand Integration', 'Content Architecture', 'CMS Strategy', 'Scalability Audit'],
      deliverables: ['Multi-page Website', 'Custom CMS Dashboard', 'Brand Design System'],
      image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=800'
    }
  },
  {
    title: 'SaaS MVP DEV',
    description: 'Building full-stack software products from zero to one. We handle the complexity so you can focus on the vision.',
    tag: '03',
    details: {
      technologies: ['Full-stack React', 'Supabase', 'API Orchestration', 'Stripe'],
      process: ['MVP Scoping', 'Database Architecture', 'Security Hardening', 'Launch Strategy'],
      deliverables: ['Functional Web App', 'Subscription Engine', 'User Management'],
