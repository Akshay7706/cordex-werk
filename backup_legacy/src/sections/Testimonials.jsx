...
const testimonials = [
  {
    ...
    content: 'Kreato Space transformed our landing page into a conversion engine. Our trial sign-ups increased by 140% in the first month. The 3D interactions are simply unmatched.',
    rating: 5
  },
  {
    name: 'Marcus Thorne',
  ...
  },
  {
    ...
    content: 'Working with Kreato Space is like having an elite technical strike team. They don\'t just write code; they design systems that scale and convert with surgical precision.',
    rating: 5
  }
];
