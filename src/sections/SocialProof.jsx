...
const PartnerLogo = ({ name }) => {
  const logos = {
    Nvidia: (
      <svg role="img" viewBox="0 0 24 24" fill="currentColor" className="h-6 md:h-8"><path d="M12 0L6.002 5.503l5.998 5.497l-5.998 5.503L12 24l12-12L12 0zm0 18.006l-4.498-4.125L12 9.756l4.498 4.125L12 18.006z"/></svg>
    ),
    OpenAI: (
